                ...
                child: Table(
                  ...
                  children: [
                    ...
                    TableRow(
                      children: [
                        Column(children: const [
                          Text('12:00-12:45', style: TextStyle(fontSize: 20.0))
                        ]),
                        Column(children: const [
                          Text('Predavanje kompanije',
                              style: TextStyle(fontSize: 20.0))
                    ...
                    TableRow(
                      children: [
                        Column(children: const [
                          Text('12:45-13:00', style: TextStyle(fontSize: 20.0))
                        ]),
                        Column(children: const [
                          Text('Slobodno vreme',
                              style: TextStyle(fontSize: 20.0))
                    ...
                    TableRow(
                      children: [
                        Column(children: const [
                          Text('16:00-17:00', style: TextStyle(fontSize: 20.0))
                        ]),
                        Column(children: const [
                          Text('Slobodno vreme',
                              style: TextStyle(fontSize: 20.0))
                    ...
                    TableRow(
                      children: [
                        Column(children: const [
                          Text('17:00-18:00', style: TextStyle(fontSize: 20.0))
                        ]),
                        Column(children: const [
                          Text('Company circle',
                              style: TextStyle(fontSize: 20.0))
                    ...
                    TableRow(
                      children: [
                        Column(children: const [
                          Text('18:00-18:15', style: TextStyle(fontSize: 20.0))
                        ]),
                        Column(children: const [
                          Text('Pauza', style: TextStyle(fontSize: 20.0))
                        ]),
                    ...
                    TableRow(
                      children: [
                        Column(children: const [
                          Text('18:15-19:00', style: TextStyle(fontSize: 20.0))
                        ]),
                        Column(children: const [
